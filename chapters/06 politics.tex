...
Extension to the Multi-Factorial Model
You propose an interplay of formal constraints, usage frequency, processing, and social norms. Beaver \& Stanley highlight a further category: patterns of arational influence, which can survive (and indeed flourish) in a linguistic community without being grounded in conscious or rational updates of shared beliefs.

    If your multi-factorial approach is to incorporate real-time heuristics and a community’s emergent judgments, you could note that sometimes, ideology-laden or affect-laden language can short-circuit speakers’ usual sense of “Is that ungrammatical, or do I just dislike it?”
    This lines up with your notion of the “feeling of ungrammaticality.” Beaver \& Stanley push that certain manipulative or sub-rational uses can produce negative or positive “vibrations,” to use Schiller’s term, that may mimic or amplify the same gut-level sense you discuss.

Empirical and Sociopolitical Ramifications
Finally, your paper’s section on how grammaticality shifts over time or across communities might dovetail with Beaver & Stanley’s discussion of how ideological uses embed themselves in a speech community.

    They provide case studies—e.g. slurs, valence framing, rhetorical devices—that concretize how broader cultural or political practices can shape (and be shaped by) seemingly neutral phenomena. That resonates well with your premise that “grammaticality emerges from stable form–meaning pairings within social-linguistic communities.”
    Citing them might enrich your argument that morphological or syntactic “structure” can’t be divorced from patterns of psychological alignment, cultural identity, or strategic advantage.