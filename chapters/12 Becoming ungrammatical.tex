...
\chapter{The onward march of \textit{do}-support}

The Middle Ages was a time of great change and upheaval in English. The language was busy absorbing French vocabulary while shedding itself of the complex inflections of Old English. Amidst all this tumult, the structure of the clause was moving from the relatively flexible word order of Old English, which relied on inflections to indicate grammatical relationships, to a more fixed word order.

In the Early Modern English of the Elizabethan period, the end of the 1500s and beginning of the 1600s, forming a question or a negative statement was a straightforward affair. The basic way to form an interrogative clause was to place the verb ahead of the subject: \textit{You think I am no stronger than my sex.} would become \textit{Think you I am no stronger than my sex?} To make a negative, you added \textit{not} after the verb: \textit{I seek not to wax great by others' waning.}

But drastic changes were coming to Modern English clause structure: \textit{do} support. To understand the significance of this change, let's first define our terms. \textit{Do}-support refers to the use of the auxiliary verb \textit{do} in constructions that do not normally require an auxiliary, such as negatives, questions, and emphatic statements. For instance, in Modern English, we say \textit{Did you see him?} instead of \textit{Saw you him?} and \textit{I did not go} instead of \textit{I went not}.

These constructions, now so integral to the fabric of Modern English, were once entirely absent from the language. In Old English (roughly 5th to 11th century AD) and early Middle English (12th to 14th century AD), questions were formed by a process known as V-to-C movement or verb fronting, where the main verb would move to the front of the clause. Negation, similarly, was achieved by placing the negative particle \textit{ne} (later \textit{not}) directly after the main verb. The auxiliary \textit{do} had no special grammatical function and was used primarily as a main verb meaning `to perform' or `to carry out.'

It wasn't until the late 15th century that \textit{do} began to make its first tentative forays into the realm of auxiliaries. Initially, it was used in affirmative statements to add emphasis, as in \textit{I \textbf{do} love you} (as opposed to the neutral \textit{I love you}). This usage gradually spread to questions and negative statements, likely as a means of maintaining the rhythm and stress patterns of the language in the face of phonological erosion and syntactic restructuring.

By the 16th and 17th centuries, \textit{do}-support had become firmly entrenched in the language, particularly in informal and colloquial registers. Shakespeare's plays are peppered with examples like \textit{I \textbf{do} not doubt} and \textit{\textbf{Do} you not hear him?}, reflecting the growing acceptance of this new grammatical tool. However, it took several more centuries for \textit{do}-support to become fully standardized across all registers and dialects of English.

The rise of \textit{do}-support is often attributed to a confluence of factors. Some linguists argue that it was a response to the loss of verb inflections and the increasing rigidity of English word order. Others point to the influence of Celtic languages, many of which have a similar auxiliary system. Still others see it as a natural consequence of the language's evolving prosodic structure, with \textit{do} serving as a handy stress-bearer in an increasingly stress-timed language.

Regardless of its origins, the emergence of \textit{do}-support in Early Modern English represents a fundamental restructuring of the language's clause structure. It paved the way for the complex system of auxiliaries and verb phrases that characterizes Modern English grammar. More importantly, it demonstrates that even core grammatical rules are subject to change over time.

This brings us to the present day and the curious case of \textit{do}-support and SAI in embedded questions. Traditionally, standard English grammar has maintained a distinction between direct questions (which require \textit{do}-support and SAI) and indirect or embedded questions (which do not). For example:

\begin{enumerate}
    \item Direct: \textit{What \textbf{did} you say?}
    \item Embedded: \textit{I wonder what you said.}
\end{enumerate}

However, in recent decades, linguists have observed a growing trend, particularly in casual speech and among younger speakers, towards using \textit{do}-support and SAI in embedded questions as well. Sentences like \textit{I wonder what \textbf{did} you say} and \textit{She asked me where \textbf{did} I go} are becoming increasingly common, blurring the line between direct and indirect question formation.

This phenomenon, known as "embedded inversion" or "embedded SAI", has been documented in various dialects of English, including American, British, and Australian English. While still considered non-standard by most grammarians, its increasing prevalence suggests that it may be an emerging feature of the language, one that could eventually gain acceptance as part of the grammatical norm.

The rise of embedded SAI mirrors the historical development of \textit{do}-support in Early Modern English in several ways. Both involve the extension of a grammatical feature (auxiliary \textit{do} and SAI) into new syntactic contexts. Both seem to have originated in informal, spoken registers before gradually spreading to more formal contexts. And both challenge traditional notions of what constitutes `correct' or `proper' English grammar.

From a linguistic perspective, the emergence of embedded SAI raises interesting questions about the nature of language change and the cognitive mechanisms that drive it. Some researchers have suggested that it reflects a general tendency towards regularization and simplification in language, with speakers extending the rules of direct question formation to embedded contexts. Others have pointed to the influence of pragmatic factors, such as the desire to mark embedded questions as more salient or to convey a sense of immediacy or involvement.

Whatever its underlying causes, the rise of embedded SAI serves as a powerful reminder that language is not a static entity but a dynamic, ever-evolving system. The very rules that we take for granted as the bedrock of English grammar are themselves the product of centuries of change and innovation. What sounds `wrong' or `ungrammatical' to one generation of speakers may be perfectly acceptable to the next.

This has important implications for how we think about language standards and grammatical correctness. Too often, we cling to a prescriptivist view of language, insisting on adherence to a narrow set of rules and conventions. But as the history of English shows us, these rules are not set in stone. They are shaped by the ever-changing needs and practices of language users.

The rise of \textit{do}-support and SAI, both in Early Modern English and in contemporary embedded questions, challenges us to adopt a more flexible and inclusive approach to grammar. It reminds us that language is not the property of grammarians and language authorities but belongs to the people who use it every day. As linguist John McWhorter puts it, ``Language is not a protocol legislated by an authority but rather a wiki that pools the contributions of millions of writers and speakers, who ceaselessly bend the language to their needs and who inexorably age, die, and get replaced by their children, who adapt the language in their turn.''

In the end, the story of \textit{do}-support and SAI is not just about a quirky grammatical rule or a curious linguistic trend. It's about the very nature of language as a human invention, constantly being shaped and reshaped by the collective creativity of its users. It's a testament to the resilience and adaptability of the English language, which has weathered countless transformations over the centuries and yet remains a vital, expressive medium for communication.

So the next time you hear someone use an embedded SAI construction like \textit{I wonder what \textbf{did} he say}, don't be too quick to dismiss it as a grammatical error. It may just be a glimpse into the future of English, a sign of the language's ongoing evolution. And who knows? In a few generations, it may be the new norm, as unremarkable as \textit{do}-support and SAI are to us today.

In the grand scheme of things, we are all just witnesses to the never-ending dance of language, participants in a global conversation that stretches back millennia and will continue long after we're gone. The rise of \textit{do}-support and SAI is just one small chapter in this vast, unfolding story – but it's a chapter that reminds us of the power and beauty of human language in all its ever-changing glory.