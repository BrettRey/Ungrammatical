...
% EDITORIAL-HPC: Calibrate this line. Asterisks are measurements only in the
% sense that they are detector readings from a fallible instrument. They still
% need a stated target, community, channel, and error profile.
