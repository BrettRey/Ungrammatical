...
A functionalist approach to grammar emphasizes the role of language use and communicative functions in shaping grammatical structures. From this perspective, a functionalist might address Hurford's challenge in the following ways:

1. Semantic distinction: A functionalist could argue that there is a subtle semantic difference between "likely" and "probable" in these constructions. "Likely" might be seen as more closely associated with the subject's inherent propensity or tendency, while "probable" might be more related to the overall probability of the event occurring. This semantic distinction could explain why "likely" is acceptable in the raising construction (1b), while "probable" is not.

2. Language use and conventionalization: Functionalists emphasize the role of language use in shaping grammar. They might argue that the raising construction with "likely" has become conventionalized through frequent use, while the same construction with "probable" has not. Over time, speakers may have found the raising construction with "likely" to be more communicatively effective or efficient, leading to its increased use and acceptability.

3. Gradience and acceptability: Functionalists often view grammaticality as a gradient phenomenon rather than a binary one. They might suggest that the acceptability of these constructions lies on a continuum, with "likely" being more acceptable than "probable" in the raising construction. This gradience could be influenced by factors such as frequency of use, semantic compatibility, and speaker preferences.

4. Diachronic development: A functionalist approach might also consider the historical development of these constructions. It is possible that the raising construction with "likely" emerged and became established earlier in the language, while the same construction with "probable" did not undergo the same path of development. Diachronic factors could thus contribute to the differences in acceptability. .

Frequency and Entrenchment:  Even if the difference started as arbitrary, one pattern might become dominant through repeated usage, eventually becoming the "default" way of expressing that idea.

In summary, a functionalist would likely address Hurford's challenge by considering factors such as subtle semantic distinctions, language use and conventionalization, gradience in acceptability, and diachronic development. They would argue that the differences in grammaticality between the two constructions arise from the complex interplay of these factors in actual language use, rather than from a strict adherence to formal rules.
